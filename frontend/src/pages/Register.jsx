        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-20 px-4 pb-12">
            <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-xl border border-gray-100">
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold text-gray-900 font-sans">Create Account</h2>
                    <p className="text-gray-500 mt-3 text-lg">Join us to start booking flights</p>
                </div>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full py-4 text-lg mt-2">Create Account</Button>
                </form>
